...
@InputType()
class PayrollRecordUpdateManyWithoutEmployeeSalariesInput {
...
export { PayrollRecordUpdateManyWithoutEmployeeSalariesInput as PayrollRecordUpdateManyWithoutEmployeeSalariesInput };
