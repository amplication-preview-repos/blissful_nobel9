...
@InputType()
class PayrollRecordCreateNestedManyWithoutEmployeeSalariesInput {
...
export { PayrollRecordCreateNestedManyWithoutEmployeeSalariesInput as PayrollRecordCreateNestedManyWithoutEmployeeSalariesInput };
